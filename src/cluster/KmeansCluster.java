...
public class KmeansCluster {
	 ...
	 * @throws IOException 
	 */
	private Map<Integer, Integer> doProcess(
			Map<Integer, Map<String, Double>> allTestSampleMap, int K) {
	 ...
	 * @throws IOException 
	 */
	private void printClusterResult(Map<Integer, Integer> kmeansClusterResult, String kmeansClusterResultFile) throws IOException {
		// TODO Auto-generated method stub
	...
	public double[] KmeansClusterMain(Map<Integer, ArrayList<String>> docs) throws IOException {
